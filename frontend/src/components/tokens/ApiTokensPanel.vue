              ...
              <div class="border border-[var(--border)] rounded-lg overflow-hidden">
                <table class="w-full text-xs">
                  <tbody class="divide-y divide-[var(--border)]">
                    ...
                    <tr class="hover:bg-[var(--bg-hover)]"><td class="px-3 py-1.5 font-mono text-green-400">GET</td><td class="px-3 py-1.5 font-mono text-[var(--text-primary)]">/cluster/resources</td><td class="px-3 py-1.5 text-[var(--text-secondary)]">Cluster CPU, memory, disk</td></tr>
